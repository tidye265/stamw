(function() {
    ...
    async function refreshVideoUrl() {
        ...
        try {
            ...
            if (expireTime && expireTime > Date.now()) {
                ...
                // If expires immediately or no expiry, set a default refresh (e.g., 3.5 mins)
                refreshTimeout = setTimeout(refreshVideoUrl, 210000); // 3.5 min
            }
        } catch (err) {
    ...
    function showControls() {
        // Add your controls logic (e.g., auto-hide)
