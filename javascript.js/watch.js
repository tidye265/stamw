...
(function() {
    ...
    // Supabase URL (from global supabase.js)
    ...
    // Load Movie (No Auth Needed – Open API)
    async function init() {
        showLoader(true);
        ...
        try {
            ...
            // Auto-play
            video.play().catch(() => {
                // If autoplay blocked, show center play button
    ...
    video.addEventListener('touchend', () => showControls());
