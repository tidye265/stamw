...
(function() {
    ...
    // Skeleton generator (for dynamic replacement)
    ...
    function initPullToRefresh() {
        ...
        document.addEventListener('touchmove', function(e) {
            ...
            if (delta > 0) {
                pullRefreshEl.style.transform = 'translateY(' + Math.min(delta * 0.3, 60) + 'px)';
            }
        }, { passive: true });
    ...
    // Prevent Movies bottom nav from navigating (since already on home)
    ...
    function init() {
        // Immediately show skeleton (already in HTML, but ensure)
        // Then check login; if succeeds, initApp.
        checkLogin();
    }
