...
(function() {
    ...
    // ===== LOGIN CHECK (exact like account.js) =====
    ...
    var homeSkeleton = document.getElementById('homeSkeleton');
    ...
    function showSkeleton() {
        ...
        if (homeSkeleton) homeSkeleton.style.display = 'block';
    }

    function hideSkeleton() {
        if (homeSkeleton) homeSkeleton.style.display = 'none';
