// non.js (Updated: Maintenance banner + Latest vs All separation, real category filtering)
...
(function() {
    ...
    //   - Shows banner if Malawi hour < 12
    //   - Auto-hides at 12:00 Malawi time
    //   - Close X dismisses for current session only
    //   - On reload, banner reappears (until 12:00)
    // ════════════════════════════════════════════════════════════
    ...
    function checkMaintenanceBanner() {
        ...
        // Show banner if BEFORE 12:00 Malawi time
        if (t.hour < 12) {
    ...
    function initMaintenanceBanner() {
        ...
        // Re-check every 30 seconds (for auto-hide at 12:00 + clock update)
