...
(function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`${SUPABASE_URL}/functions/v1/admin-login-api`, {
                method: 'POST',
                headers: {
            ...
            // Redirect to admin dashboard (or any admin page)
            window.location.href = 'admin-dashboard.html'; // Adjust to your admin dashboard page
