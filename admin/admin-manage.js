...
(function() {
  ...
  form.addEventListener('submit', async function(e) {
    ...
    try {
      // ===== 1. Upload Poster using FormData =====
      ...
      updateProgress(20, 'Poster uploaded! Calling backend...');

      // ===== 2. Call Backend =====
      console.log('Calling upload-film-api...');
      ...
      try {
        ...
        // If JSON parse fails, throw error with the actual text
