...
(function() {
  ...
  form.addEventListener('submit', async function(e) {
    ...
    let seriesId = null; // Will hold the first episode's ID for new series

    // For continue, use the selected film's series_id (or its own ID)
    ...
    for (let i = 0; i < queue.length; i++) {
      ...
      // If this is the first episode of a new series and we don't have seriesId yet, set it
