...
(function() {
  ...
  const revenueFeeEl = document.getElementById('revenueFee'); // Now shows 30% only
  ...
  async function loadStats() {
    ...
    try {
      ...
      // 5. Revenue Fee = 30% (Just show "30%" – no amount)
  ...
  window.editFilm = async function(id) {
    try {
      // Fetch film details from backend (or supabase directly)
